...
const background = new THREE.TextureLoader().load('https://i.imgur.com/kytbhMs.jpg');
scene.background = background;

// Avatar

const kyleTexture = new THREE.TextureLoader().load('https://i.imgur.com/d3r9nKB.jpg');
